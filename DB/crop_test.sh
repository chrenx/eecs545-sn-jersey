...
# CUDA_VISIBLE_DEVICES=0 python util.py experiments/ASF/td500_resnet50_deform_thre_asf.yaml --result_dir /home/yuningc/jersey-2023/test_filter/images --image_path /home/yuningc/jersey-2023/test/images --resume /home/yuningc/DB/models/finetune_ctw1500_res50_dcn_fpn_dbv2 --box_thresh 0.15 --visualize --image_short_side 128 


CUDA_VISIBLE_DEVICES=0 python util.py experiments/seg_detector/bbjr_resnet50.yaml --result_dir /home/yuningc/jersey-2023/test_crop/images --image_path /home/yuningc/jersey-2023/test_filter/images --resume /home/yuningc/DB/outputs/workspace/DB/SegDetectorModel-seg_detector/deformable_resnet50/L1BalanceCELoss/model/final --box_thresh 0.53 --visualize --image_short_side 128
