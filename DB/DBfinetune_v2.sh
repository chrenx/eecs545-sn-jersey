...
#SBATCH --output=DBfinetune_v3.log
...
# python test.py
CUDA_VISIBLE_DEVICES=0 python train.py experiments/seg_detector/bbjr_resnet50.yaml --num_gpus 1 --validate #--debug #jersey_test.yaml --num_gpus 1 --validate --debug
